...
price1.addEventListener("click", () => {
  if (price1.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&price_gte=300&price_lte=500"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
price2.addEventListener("click", () => {
  if (price2.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&price_gte=699&price_lte=999"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
price3.addEventListener("click", () => {
  if (price3.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&price_gte=1000&price_lte=1499"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
price4.addEventListener("click", () => {
  if (price4.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&price_gte=1500&price_lte=2499"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
black.addEventListener("click", () => {
  if (black.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&color=black"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
white.addEventListener("click", () => {
  if (white.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&color=white"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
yellow.addEventListener("click", () => {
  if (yellow.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&color=yellow"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
Manyavar.addEventListener("click", () => {
  if (Manyavar.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&brand=Manyavar"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
Showoff.addEventListener("click", () => {
  if (Showoff.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&brand=Showoff"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
Mufti.addEventListener("click", () => {
  if (Mufti.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&brand=Mufti"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
Shoeland.addEventListener("click", () => {
  if (Shoeland.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&brand=Shoeland"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
longkurtas.addEventListener("click", () => {
  if (longkurtas.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=longkurtas"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
slimfitSweatshirts.addEventListener("click", () => {
  if (slimfitSweatshirts.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=slim%20fit%20Sweatshirts"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
RegularfitSweatshirts.addEventListener("click", () => {
  if (RegularfitSweatshirts.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=Regular%20fit%20Sweatshirts"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
slimfitjacket.addEventListener("click", () => {
  if (slimfitjacket.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=slim%20fit%20jacket"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
regularfitjacket.addEventListener("click", () => {
  if (regularfitjacket.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=regular%20fit%20jacket"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
regularfithoodie.addEventListener("click", () => {
  if (regularfithoodie.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=regular%20fit%20hoodie"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
regularfit.addEventListener("click", () => {
  if (regularfit.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=regular%20fit"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
longlength.addEventListener("click", () => {
  if (longlength.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=long%20length"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
shortlength.addEventListener("click", () => {
  if (shortlength.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=short%20length"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
Slimfit.addEventListener("click", () => {
  if (Slimfit.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=Slim%20fit"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
regular.addEventListener("click", () => {
  if (regular.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.type=regular "
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
partywear.addEventListener("click", () => {
  if (partywear.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.occasion=casual%20wear%20and%20party%20wear"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
casualwear.addEventListener("click", () => {
  if (casualwear.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.occasion=casual%20wear"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
ethnicwear.addEventListener("click", () => {
  if (ethnicwear.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.occasion=ethnic%20wear"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
festivewear.addEventListener("click", () => {
  if (festivewear.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.occasion=festive%20wear"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
sportswear.addEventListener("click", () => {
  if (sportswear.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.occasion=sports%20wear"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
...
workwear.addEventListener("click", () => {
  if (workwear.checked == true) {
    fetch(
      "https://testapi2-9psr.onrender.com/Products?category=Men&description.occasion=casual%20wear%20and%20office%20wear"
    )
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
